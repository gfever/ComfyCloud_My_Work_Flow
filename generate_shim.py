"""Small helper to write a sanitized Real-ESRGAN shim file.
Usage:
    python3 generate_shim.py --out /kaggle/working/Real-ESRGAN/inference_with_shim_full.py
If --out is omitted, writes to ./inference_with_shim_full.py
"""
import argparse
import textwrap
